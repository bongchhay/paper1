...
<body class="body1">
  ...
  <center>
    ...
    <h1 class="font2">តារ៉ាងទិន្នន័យចាស់ៗរបស់គ្រូបង្រៀន</h1>
  </center>
  </div><!-- <ក្បាលលើ>បិទ -->
...
<table border="2" width="100%" style="border-collapse:collapse;"><!-- <table>001 -->
                ...
                <th colspan="3"><!-- <th>002 -->
                  <center>
                  <a href="../Teacher/teacher.php" class="text-light"><input name="btnsearch" type="submit" class="btn btn-primary" style="width:1040px;height:50px;" value="ទិន្នន័យថ្មីៗ"></a>
                <a href="../Teacher_Old_Date/teacher_Delete.php" class="text-light"><input name="btnsearch" type="submit" class="btn btn-danger" style="width:200px;height:50px;" value="ទិន្នន័យដែលបានលុប"></a></center>
                 </th><!-- <th>002 -->
                </tr><!-- <tr>002 -->
                  <tr><!-- <tr>001 -->
                  <th colspan="3"><!-- <th>001 -->

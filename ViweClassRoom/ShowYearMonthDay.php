...
<body class="body1">
  ...
  <center>
    ...
    <h1 class="font2">តារាងទិន្នន័យក្នុងមួយថ្ងៃ</h1>
  </center>
  </div><!-- <ក្បាលលើ>បិទ -->
  <div class="IP3">
  <center>
...
<center>
  <form method="post">
  <!-- <label class="font5">Enter______________________________________គ្រាន់តែដកឃ្លា :</label> -->
    <label >បញ្ចូលថ្ងៃទីខែឆ្នាំ :</label>
   ...
   StudenID,
     ...
     BackMonth
          ...
          if ($result->num_rows > 0) {
           ...
           echo'<tr>
           <td colspan="21">ចំណូលសរុបក្នុងឆ្នាំ'.$StartDate.'='.$totalPrice.'$</td>
           </tr>
         ';
         echo'

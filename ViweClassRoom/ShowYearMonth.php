...
if(isset($_POST['submit'])){
  ...
  $month=$_POST['month'];
    ...
    $year=0000;
    if(empty($month)){
      header("Location: ../ViweClassRoom/ShowYearMonth.php");
    }	        // exit();
	}
  else if(empty($month)){
    $month=0000;
...
<body class="body1">
  ...
  <center>
    ...
    <h1 class="font2">តារាងទិន្នន័យក្នុងមួយខែ</h1>
  </center>
  </div><!-- <ក្បាលលើ>បិទ -->
  <div class="IP3">
  <center>
...
<center>
  ...
  <!-- <label class="font5">Enter___________________គ្រាន់តែដកឃ្លា :</label> -->
    ...
    <button class="btn btn-primary" style="width:250px;height:35px;"><a href="../ViweClassRoom/ShowAllMonth.php" class="text-light">មើលទិន្នន័យក្នុងខែនីមួយៗ</a></button>
</form>
</center>
<div class="scroll">
<table border="2" >
...
if(isset($year) && isset($month)) {
    ...
    <strong class="font3">អ្នកភ្លេចបំពេញខែហើយ!!!</strong>
    </div>
        ';
 
      }else if (empty($year)=='0000') {
  ...
  <strong class="font3">សុំទោស។ទិន្នន័យដែលអ្នកស្វែងរកមិនមានទេ!!!</strong>
    ...
    echo'<tr>
    <td colspan="21">ចំណូលក្នុងខែ'.$month.'ឆ្នាំ'.$year.'='.$totalPrice.'$</td>
    </tr>
';
echo'

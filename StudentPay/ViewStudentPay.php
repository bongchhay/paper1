...
<body class="body1">
    ...
    <div class="IP3">
      ...
      <a href="../TuitionFees/ViewTuitionFees_student.php" class="text-light"><input name="btnsearch" type="submit" class="btn btn-primary" style="width:1247px;height:50px;" value="Back"></a>
      </center>
      </div><!-- divបិទIP3 -->    
    <div class="IP4">
    <div class="scroll2">

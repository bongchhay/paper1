...
<body class="body1">
  ...
  <center>
    ...
    <h1 class="font2">តារ៉ាងទិន្នន័យបង់ប្រាក់អោយសិស្សចាស់ៗ</h1>
  </center>
  </div><!-- <ក្បាលលើ>បិទ -->
...
<div class="IP9">
    <a href="Payment.php" ><button class="btn btn-primary" style="width:1150px;height:50px;" >ចុះឈ្មោះសិស្សថ្មី</button></a>
  </div>
       ...
       if($result){
        while($row=mysqli_fetch_assoc($result)){
          ...
          if ($dateTimestamp1 > $dateTimestamp2){//（ដល់ថ្ងៃបង់ <= មិនទាន់ដល់  ）
            ...
            <button class="btn btn-primary"><a href="NextPay.php?updateid='.$id.'" class="text-light">NextPay</a></button>

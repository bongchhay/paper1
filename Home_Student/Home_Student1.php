...
<label >ឈ្មោះគ្រូ :</label>
    ...
    <div class="pp1"><button class="btn btn-primary" style="width:140px;height:35px;"><a href="../Home_Student/Home_Student.php" class="text-light">ជ្រើសរើសថ្នាក់</a></button></div>
</th>
</tr>
</form>

...
<body class="body1">
  ...
  <center>
    ...
    <h1 class="font2">តារ៉ាងទិន្នន័យគ្រូបង្រៀនដែលបានលុបនិងមុនកែប្រែ</h1>
  </center>
  </div><!-- <ក្បាលលើ>បិទ -->
...
<table border="2" width="100%" style="border-collapse:collapse;"><!-- <table>001 -->
                ...
                <th colspan="3"><!-- <th>002 -->
                  <center>
                  <a href="../Teacher/teacher.php" class="text-light"><input name="btnsearch" type="submit" class="btn btn-primary" style="width:1247px;height:50px;" value="ទិន្នន័យថ្មីៗ"></a>
                <!-- <a href="add_name.php" class="text-light"><input name="btnsearch" type="submit" class="btn btn-danger" style="width:87px;height:50px;" value="Old_Date"></a> -->
</center>
                 </th><!-- <th>002 -->
                </tr><!-- <tr>002 -->
                  <tr><!-- <tr>001 -->
...
<table border="2" width="100%" style="border-collapse:collapse;">
  ...
  <tbody>
    ...
    <?php
       $sql="Select * from `tbl_teacher_old`";
       ...
       if($result){
        while($row=mysqli_fetch_assoc($result)){
          ...
          $Other=$row['Other'];
          echo'<tr>
          <td style="text-align: center;">TOD'.$id.'</td>
